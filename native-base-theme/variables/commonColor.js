...
const brandPrimary = '#5A81FC';
const brandSecondary = '#1E73BE';
const grayDarker = '#5B5B5B';
const grayDark = '#6F8282';
const gray = '#97ABAB';
const grayLight = '#DBE8E8';
const grayLighter = '#F1F6F6';

const primaryFont = 'Lato';
const primaryFontBold = 'Lato_bold';
...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'System' : primaryFont,
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'System' : primaryFont,
  titleFontSize: platform === PLATFORM.IOS ? 14 : 16,
  subTitleFontSize: platform === PLATFORM.IOS ? 11 : 14,
  subtitleColor: platform === PLATFORM.IOS ? '#000' : '#fff',
  titleFontColor: platform === PLATFORM.IOS ? '#000' : '#fff',

  // Other
  borderRadiusBase: platform === PLATFORM.IOS ? 5 : 4,
